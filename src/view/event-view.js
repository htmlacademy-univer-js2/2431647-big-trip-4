...
function getEventOffers(event) {
  ...
  return eventTypeOffer.offers.filter((offer) =>
...
function createEventTemplate(event) {
  ...
  return `
    <li class="trip-events__item">
      <div class="event">
        <time class="event__date" datetime="${dateFrom}">${humanizeDate(
    dateFrom,
    DATE_FORMAT_DAY
  )}</time>
        ...
        <div class="event__schedule">
          <p class="event__time">
            <time class="event__start-time" datetime="${dateFrom}">${humanizeDate(
    dateFrom,
    DATE_FORMAT_HOURS
  )}</time>
            &mdash;
            <time class="event__end-time" datetime="${dateTo}">${humanizeDate(
    dateTo,
    DATE_FORMAT_HOURS
  )}</time>
          </p>
